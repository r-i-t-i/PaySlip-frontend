...
export class FabricjsEditorComponent implements AfterViewInit {
  ...
  public compString1 : string;
  public compString2: string;
...
var labelText = new fabric.Text(this.compString1, {
  left: 10,
  top: 10,
  fontSize: 16
});
var labelText1 = new fabric.Text(this.compString2, {
  left: 240,
  top: 10,
  fontSize: 16
});
// create a Fabric.js rectangle
var inputRect = new fabric.Rect({
  left: 5,
  top: 10,
  width: 220,
  height: 20,
...
// create a group with the text object and rectangle
var formField = new fabric.Group([ labelText, labelText1, inputRect], {
  left: 100,
  top: 100,
});
this.canvas.add(formField);
      this.compString1 = '';
      this.compString2 = '';
  ...
  setCanvasImage() {
    ...
    if (this.props.canvasImage) {
      this.canvas.setBackgroundColor(new fabric.Pattern({ source: this.props.canvasImage, repeat: 'repeat' }), () => {
        ...
        // self.setActiveProp('background-image', this.props.canvasImage);
      });
    }
  }
